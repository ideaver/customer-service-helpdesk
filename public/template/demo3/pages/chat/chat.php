...
<div class="row chat-wrapper">
            ...
            <div class="tab-pane fade show active" id="chats" role="tabpanel" aria-labelledby="chats-tab">
                ...
                <ul class="list-unstyled chat-list px-1">
                    ...
                    <a href="javascript:;" class="d-flex align-items-center">
                        ...
                        <div>
                        <p class="text-body fw-bolder">Mariana Zenha (Partner) - 082246054709</p>
                    ...
                    <a href="javascript:;" class="d-flex align-items-center">
                        ...
                        <div class="d-flex justify-content-between flex-grow-1 border-bottom">
                        <div>
                            <p class="text-muted tx-13"><i data-feather="check" class="text-muted icon-md mb-2px"></i> Admin - Ari Lesmana</p>
                            <p class="text-body fw-bolder">Mariana Zenha (Partner) - 082246054709</p>
    ...
    <div class="col-lg-8 chat-content">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div>
                <p class="text-muted tx-13"><i data-feather="check" class="text-muted icon-md mb-2px"></i> Admin - Ari Lesmana</p>  
                <p class="text-body fw-bolder"><a href="#" style="text-decoration:underline">Mariana Zenha (Partner) - 082246054709 </a></p>
